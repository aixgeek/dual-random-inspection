...
export interface UpdateFormProps {
  onCancel: () => void;
  onSubmit: (id: string, values: Partial<API.DualRandomResult>) => void;
  updateModalVisible: boolean;
  values: Partial<API.DualRandomResult>;
}

export interface UpdateFormState {
  formVals: Partial<API.DualRandomResult>;
  currentStep: number;
}
...
const UpdateForm: React.FC<UpdateFormProps> = (props) => {
  ...
  const handleSubmit = async () => {
    ...
    handleUpdate(values._id as string, { ...fieldsValue });
  };
